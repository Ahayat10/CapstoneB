...
def main():
    for folder in ['train','valid']:
        image_path = os.path.join(os.getcwd(), ('/content/drive/MyDrive/CapstoneB/XMLVOC/' + folder))
        xml_df = xml_to_csv(image_path)
        xml_df.to_csv(('/content/drive/MyDrive/CapstoneB/XMLVOC/' + folder + '_labels.csv'), index=None)
